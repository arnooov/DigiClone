...
import 'alaw.dart'; // Replace with the actual file name of your ALawPage
...
class _MyHomePageState extends State<MyHomePage> with SingleTickerProviderStateMixin {
  ...
  String encoding(String? n) {
    ...
    if (n.length != 14 || !isBinary(n)) {
      showSnackBar('Entered number must be 14-bit long and binary');
  ...
  void _encodeNumber() {
    setState(() {
      ...
      _encodedNumber = encoding(inputNumber);
  ...
  void _decodeNumber() {
    setState(() {
      ...
      _decodedNumber = decoding(inputNumber);
    });
            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: 'Binary number (Ex: 10000100010000)',
                  filled: true,
